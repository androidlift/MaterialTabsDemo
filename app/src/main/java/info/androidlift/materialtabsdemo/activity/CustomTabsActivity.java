...
public class CustomTabsActivity extends AppCompatActivity {
    ...
    private void setupTabIcons() {
        ...
        tabOne.setText("MON");
        tabOne.setCompoundDrawablesWithIntrinsicBounds(0, R.drawable.ic_dashboard_white_24dp, 0, 0);
        tabLayout.getTabAt(0).setCustomView(tabOne);

        TextView tabTwo = (TextView) LayoutInflater.from(this).inflate(R.layout.custom_tab, null);
        tabTwo.setText("TUE");
        tabTwo.setCompoundDrawablesWithIntrinsicBounds(0, R.drawable.ic_donut_small_white_24dp, 0, 0);
        tabLayout.getTabAt(1).setCustomView(tabTwo);

        TextView tabThree = (TextView) LayoutInflater.from(this).inflate(R.layout.custom_tab, null);
        tabThree.setText("WED");
        tabThree.setCompoundDrawablesWithIntrinsicBounds(0, R.drawable.ic_extension_white_24dp, 0, 0);
